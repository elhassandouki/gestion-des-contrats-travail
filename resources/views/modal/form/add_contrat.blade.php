...
<form class="form-horizontal" id="form-save" method="post" action="{{route($role.'-Contrat-store')}}" >
     @csrf
        <div class="form-group">
          <div class="col-md-2">
            <label for="ferme" class=" control-label">CIN</label>
            <input type="hidden" class="form-control" id="id" name="id">
            <input type="text" class="form-control" id="cin_employee" value="{{$Employee->cin }}" readonly="" name="cin_employee">
          </div>
          <div class="col-md-2">
